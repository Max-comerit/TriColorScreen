...
import ImageIcon from '~/assets/images/custom-design/textile-advertisement-decor/image-icon.svg?component'
import TextIcon from '~/assets/images/custom-design/textile-advertisement-decor/text-icon.svg?component'
