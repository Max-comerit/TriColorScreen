/**
 * Screen Printing & Embroidery Services Data
 *
 * Hardcoded services for screen printing and embroidery category
 */

interface IScreenPrintingEmbroideryService {
  title: string
  description: string
  imageSrc: string
  alt: string
...
export const screenPrintingEmbroideryServices: IScreenPrintingEmbroideryService[] = [
  {
